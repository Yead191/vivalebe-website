      ...
      >
              ...
              <FormItem className="flex items-center gap-2 space-y-0">
                <FormControl>
                  <Checkbox
                    ...
                    className="rounded-md border-neutral-300 data-[state=checked]:bg-[#429CA8] data-[state=checked]:border-[#429CA8]"
                  />
                </FormControl>
                <FormLabel className="text-neutral-600 font-medium cursor-pointer select-none">
                  {dict.auth?.labels?.rememberMe}
                </FormLabel>
              </FormItem>
            )}
          /> */}
        ...
        <p className="text-center text-xs text-neutral-500 mt-2">
          ...
          <Link
            ...
            className="font-bold text-[#429CA8] hover:underline"
          >
