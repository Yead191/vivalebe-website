    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-sm text-neutral-500">
          {t.privacy.desc || "Control who can view your profile details."}
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-3">
          {premiumOptions.map((opt) => {
            ...
            return (
              ...
              >
                <span className="text-sm text-neutral-600  font-medium group-hover:text-neutral-900 ">
                  {opt.label}
                </span>
                <div
                  className={cn(
      ...
      {/* Regions Settings */}
      <div className="space-y-3">
        <h3 className="text-sm font-bold tracking-tight text-neutral-400 uppercase">
          {t.privacy.regionTitle}
        </h3>
      ...
      <div className="space-y-4 pt-4 border-t border-neutral-100 ">
        ...
        <div className="space-y-1 bg-neutral-50/50  p-4 rounded-2xl border border-neutral-100 ">
          {[
            ...
            {
              state: hideOnline,
              setter: setHideOnline,
              label: t.privacy.hideOnline,
            },
            {
              state: hideMoments,
              setter: setHideMoments,
              label: t.privacy.hideMoments,
            },
          ].map((item, idx) => (
            <div
              key={idx}
              className="flex items-center justify-between py-3 first:pt-0 last:pb-0 border-b last:border-0 border-neutral-100 "
            >
