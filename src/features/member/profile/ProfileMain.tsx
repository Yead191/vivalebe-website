...
export function ProfileMain({ lang, dict, user, isPremium = false }: Props) {
  ...
  return (
    <div className="relative">
      {!isPremium && (
        <div className="absolute inset-0 z-50 flex flex-col items-center justify-start overflow-visible p-4 pt-[20vh]">
          <div className="bg-background/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-border text-center max-w-md w-full sticky top-[30vh]">
            <h3 className="text-xl font-bold text-foreground mb-3">
              Premium Feature
            </h3>
            <p className="text-sm text-muted-foreground mb-6">
              Upgrade your membership to unlock all premium features and view
              full profiles.
            </p>
            <Link
